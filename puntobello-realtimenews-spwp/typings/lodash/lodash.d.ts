...
- [x] Removed _.where in favor of _ with iteratee shorthand
...
declare module _ {
    ...
    **/
    ...
    interface LoDashStatic {
         ...
         * have the properties of the given object, else false.
         *
         * Note: Unlike _, this method mutates array.
         *
         * @param array The array to modify.
         * @param predicate The function invoked per iteration.
         * @param thisArg The this binding of predicate.
    ...
    interface LoDashStatic {
         ...
         * have the properties of the given object, else false.
         *
         * Many lodash methods are guarded to work as iteratees for methods like _.every, _, _.map, _.mapValues,
         * _.reject, and _.some.
         *
    ...
    interface LoDashStatic {
        /**
         * The opposite of _; this method returns the elements of collection that predicate does not return
         * truthy for.
         *
         * @param collection The collection to iterate over.
         * @param predicate The function invoked per iteration.
