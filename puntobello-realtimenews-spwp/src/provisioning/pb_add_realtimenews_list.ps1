...
Add-PnPField -List $newsListTitle -DisplayName "Sticky date" -InternalName "pb_StickyDate" -Id $GUID_pb_StickyDate -Group "PuntoBello" -AddToDefaultView  -Type DateTime
